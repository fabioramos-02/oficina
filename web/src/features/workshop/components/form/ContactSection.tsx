      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              {...register('telefone')}
              className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none ${errors.telefone ? 'border-red-500 bg-red-50' : 'border-gray-300'}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              {...register('email')}
              className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none ${errors.email ? 'border-red-500 bg-red-50' : 'border-gray-300'}`}
